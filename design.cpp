...
void draw() {
    ...
    for(i=0;i<size;i+=3){
    	glVertex3f(getX(getElem(l,i)),getY(getElem(l,i)),getZ(getElem(l,i)));
		glVertex3f(getX(getElem(l,i+1)),getY(getElem(l,i+1)),getZ(getElem(l,i+1)));
		glVertex3f(getX(getElem(l,i+2)),getY(getElem(l,i+2)),getZ(getElem(l,i+2)));
    }
