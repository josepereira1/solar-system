...
CPP_FILES_EXCLUDE=src/generator.cpp src/engine.cpp src/xmlParser.cpp
...
gen : 
	generator sphere 2 5 5 sphere.3d
...
generate: install
	...
	cp sphere1.3d sphere2.3d sphere3.3d teapot.xml teapot.3d bin/
	cp sphere1.3d sphere2.3d sphere3.3d teapot.xml teapot.3d bin_windows_engine/
